...
//
//   const paisesRespuesta = Convert.toPaisesRespuesta(json);
//
...
/* export class Convert {
  public static toPaisesRespuesta(json: string): PaisesRespuesta[] {
    return cast(JSON.parse(json), a(r('PaisesRespuesta')));
  }

  public static paisesRespuestaToJson(value: PaisesRespuesta[]): string {
    return JSON.stringify(uncast(value, a(r('PaisesRespuesta'))), null, 2);
  }
}
